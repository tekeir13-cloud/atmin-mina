...
const CACHE_V = 'mukicloud-v2026.09.05-146';
...
self.addEventListener('fetch', (e) => {
  ...
  if (url.pathname === '/tareo' || url.pathname.endsWith('/tareo.html') ||
      url.pathname === '/registro' || url.pathname.endsWith('/registro.html') ||
